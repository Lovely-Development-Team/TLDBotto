...
def parse(config):
    defaults = {
        ...
        "triggers": {
            ...
            "yell_david": ["!bottoyellatdavid"],
            "yell_ben": ["!bottoyellatben"],
            "yell_rose": ["!bottoyellatrose"],
            "yell_izzy": ["!bottoyellatizzy"],
            "yell_grey": ["!bottoyellatgrey"],
            "yell_dom": ["!bottoyellatdom"],
            "yell_madi": ["!bottoyellatmadi"],
            "yell_kirk": ["!bottoyellatkirk"],
        },
        "timezones": [],
        "meals": {
